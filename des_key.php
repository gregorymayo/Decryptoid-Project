...
<?php
    ...
    function getShiftTable($input){
        ...
        return $shiftTable[$input];
    }
    function getArrayParity(){
        $parityArray = array (  
            57,49,41,33,25,17,9, 
            1,58,50,42,34,26,18, 
            10,2,59,51,43,35,27, 
    ...
    function getInitialPermutation(){
        $initialPermutationArray = array(
        ...
        return $initialPermutationArray;
    }
    function getFinalPermutation(){
        $finalPermutationArray =  array(
    ...
    function getComp2($param1,$param2,$param3){
        $compare2 = array ( 
            array( 
        ...
        return $compare2[$param1][$param2][$param3];
    }
?>